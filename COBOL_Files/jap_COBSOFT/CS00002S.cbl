      ...
      *>=================================================================================      
       ...
       78   c-ThisProgram                        value "CS00002S".
       ...
       2000-Processing_Shori section.     
            ...
            evaluate true
                 ...
                 when lnk-carregar-prametros
                      perform 2100-carregar-Parameters             
      ...
      *>=================================================================================
       2100-carregar-diretorios section.     
            ...
            or   ws-computador-hbsis
                 set lnk-Development_Kaihatsu           to true
                 move "C:\CobSoft\cgi"             to lnk-cgi-path
                 move "C:\CobSoft\dat"             to lnk-DataPath
                ...
                perform until not ws-OperationOK
                      ...
                      evaluate ws-alias-path
                           ...
                           when "DAT"
                                move ws-dir-path   to lnk-DataPath
                           when "TMP"
      ...
      *>=================================================================================
       2100-carregar-Parameters section.
